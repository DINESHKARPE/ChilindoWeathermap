...
/**
 * Manages "Authentication" to Chilindo weathermap backend service.  The SyncAdapter framework
 ...
 */
public class ChilindoAuthenticator extends AbstractAccountAuthenticator {

    public ChilindoAuthenticator(Context context) {
        super(context);
    }
